  ...
  render: () => {
    return `
      <div class='onxl20 smooth-appear' id='onxl20'>
        ...
        <div class='opyz3b' id='opyz3b'>
          <div class='y3883o' id='y3883o'></div>
        </div>
...
const pageSeasonStatistics = `
  <div class='oeqei5 smooth-appear-fast' id='oeqei5'>
    ...
    <div class='z270vz'>
      ...
      <div class='z78k3z' id='ios2a73y'>
        <div class='r7vm3d ms-0' condition='1'>Только гонка</div>
        <div class='r7vm3d' condition='2'>Гонка и спринт</div>
        <div class='r7vm3d me-0' condition='0'>Только спринт</div>
      </div>

      <div class='rizrwb sowwkn'></div>
    ...
    <div class='tu7r3m' id='tu7r3m'>

      <div class='k19ess' id='season-statistics-scroll-leaders'>
        <div class='rr8xbo'>
        
          <div class='aoy0bl'>ЛИДЕРЫ СЕЗОНА</div>
      ...
      <div class='k19ess' id='season-statistics-scroll-overtakes'>
        <div class='rr8xbo'>
      ...
      <div class='k19ess' id='season-statistics-scroll-start'>
        <div class='rr8xbo'>
      ...
      <div class='k19ess' id='season-statistics-scroll-cards'>
        <div class='rr8xbo'>
      ...
      <div class='k19ess' id='season-statistics-scroll-mistakes'>
        <div class='rr8xbo'>
...
const pageSeasonCategories = `
  ...
  <div class='bkyv96 smooth-appear-fast' id='bkyv96'>
    ...
    <div class='i026jp j530fy'>

      <div class='is4200 invisible' id='l881mskeoc-body'>
        <div class='hfkanh'>

          <div class='lnq8e3' id='l881mskeoc-close'>
      ...
      <div class='i026jp-body vm531e'>
        ...
        <div class='hm471b'>
          ...
          <div class='i026jp-legend s602nh'>
            ...
            <div class='pw854k' id='b279kymgiw'>
              <img src='img/refresh.svg'>
            </div>

            <div class='dropdown-s-container s415jf'>
              <div class='dropdown-s m978pe' id='dropdown-1-2'>
                <div class='dropdown-s-title-container r449cl'>
                  <div class='dropdown-s-title' id='dropdown-1-2-title'>Позиция в рейтинге</div>
                  <div class='dropdown-s-title-button'>
                    <img class='dropdown-s-caret' id='dropdown-1-2-caret' src='img/caret-dropdown.svg'>
                  </div>
                </div>
                <div class='dropdown-s-border dropdown-s-menu-closed' id='dropdown-1-2-border'></div>
                <div class='dropdown-s-menu dropdown-s-menu-closed' id='dropdown-1-2-menu'></div>
              </div>
            </div>
...
const pageSeasonComparison = `
  ...
  <div class='q4z5nn smooth-appear-fast' id='q4z5nn'>
    ...
    <div class='qxuqtm'>
      <div class='taisj1'>
        <div class='a63icc'>
          ...
          <div class='e9g58e'>
            <div class='dropdown-c-container j-end' id='dropdown-1-3-left-container'>
              <div class='dropdown-c' id='dropdown-1-3-left'>
                <div class='dropdown-c-title' id='dropdown-1-3-title-left'></div>
                <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='dropdown-1-3-caret-left'>
                <div class='dropdown-c-menu-container'>
                  <div class='dropdown-c-menu' id='dropdown-1-3-menu-left'></div>
                </div>
              </div>
          ...
          <div class='gp85ug he-125 me-1 ms-2'></div>
  
          <div class='dropdown-c-container' id='dropdown-1-3-center-container'>
          
            <div class='icon-backward-container-c' id='dropdown-1-3-center-backward' typeIt='backward'>
              <img src='img/navigation-backward-c.svg' class='icon-navigation-c'>
            </div>
            <div class='dropdown-c' id='dropdown-1-3-center'>
              <div class='dropdown-c-title' id='dropdown-1-3-title-center'></div>
              <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='dropdown-1-3-caret-center'>
            </div>
            <div class='icon-forward-container-c' id='dropdown-1-3-center-forward' typeIt='forward'>
              <img src='img/navigation-forward-c.svg' class='icon-navigation-c'>
            </div>
            
            <div class='dropdown-c-menu-container'>
              <div class='dropdown-c-menu' id='dropdown-1-3-menu-center'></div>
            </div>
            
          </div>
  
          <div class='gp85ug he-125 ms-1 me-2'></div>
  
          <div class='aoktu6'>
            <div class='dropdown-c-container j-start' id='dropdown-1-3-right-container'>
              <div class='dropdown-c' id='dropdown-1-3-right'>
                <div class='dropdown-c-title' id='dropdown-1-3-title-right'></div>
                <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='dropdown-1-3-caret-right'>
                <div class='dropdown-c-menu-container'>
                  <div class='dropdown-c-menu' id='dropdown-1-3-menu-right'></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class='flex-column'>
      ...
      <div class='i026jp mt-2' id='kzcayqv8'>

        <div class='is4200 invisible' id='nybo1xw5-table'>
          <div class='hfkanh'>
  
            <div class='lnq8e3' id='nybo1xw5-close'>
              <img src='img/close-cross-no-space.svg'>
            </div>
        ...
        <div class='i026jp-legend ps-05'>
          ...
          <img class='oossip' src='img/refresh.svg' id='llbmuz445w'>
          ...
          <div class='dropdown-c-container j-start' id='dropdown-1-4-container'>
            <div class='dropdown-c px-0' id='dropdown-1-4'>
              <div class='dropdown-c-title' id='dropdown-1-4-title'></div>
              <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='dropdown-1-4-caret'>
              <div class='dropdown-c-menu-container dropdown-c-menu-container-left'>
                <div class='dropdown-c-menu dropdown-menu-left' id='dropdown-1-4-menu'></div>
              </div>
            </div>
          </div>
        ...
        <div class='i026jp-body flex-column px-0 pb-0'>
  
          <div class='d3-chart flex-column p-relative' id='chart-1'></div>
...
const pageSeasonPace = `
  ...
  <div class='kgh9j9 smooth-appear-fast' id='kgh9j9'>
    ...
    <div class='m7qu9v'>
      ...
      <div class='dropdown-c-container j-end' id='tj2uf8ip-container'>
        <div class='dropdown-c' id='tj2uf8ip'>
          <div class='dropdown-c-title' id='tj2uf8ip-title'></div>
          <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='tj2uf8ip-caret'>
          <div class='dropdown-c-menu-container'>
            <div class='dropdown-c-menu' id='tj2uf8ip-menu'></div>
          </div>
        </div>
      </div>

      <div class='rizrwb zdv1cn'></div>

      <div class='dropdown-c-container j-start' id='tvgojarr-container'>
        <div class='dropdown-c' id='tvgojarr'>
          <div class='dropdown-c-title' id='tvgojarr-title'></div>
          <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='tvgojarr-caret'>
          <div class='dropdown-c-menu-container dropdown-c-menu-container-left'>
            <div class='dropdown-c-menu dropdown-menu-left' id='tvgojarr-menu'></div>
          </div>
        </div>
      </div>
      ...
      <div class='dropdown-c-container j-start' id='ijum8o49-container'>
        <div class='dropdown-c' id='ijum8o49'>
          <div class='dropdown-c-title' id='ijum8o49-title'></div>
          <img class='dropdown-caret-c' src='img/caret-dropdown.svg' id='ijum8o49-caret'>
          <div class='dropdown-c-menu-container dropdown-c-menu-container-left'>
            <div class='dropdown-c-menu dropdown-menu-left' id='ijum8o49-menu'></div>
          </div>
        </div>
      </div>
      ...
      <div class='i026jp pn760o'>
        ...
        <div class='is4200 invisible' id='tc47btbe-table'>
          <div class='hfkanh'>
            ...
            <div class='lnq8e3' id='tc47btbe-close'>
              <img src='img/close-cross-no-space.svg'>
            </div>
        ...
        <div class='i026jp-legend'>
          ...
          <div class='v-line a-s-center row-stretch my-025 mx-2'></div>
      ...
      <div class='i026jp vv403s'>
        ...
        <div class='i026jp-desc invisible' id='qeh9jy7q-table'>
          <div class='hfkanh'>
            ...
            <div class='lnq8e3' id='qeh9jy7q-close'>
              <img src='img/close-cross-no-space.svg'>
            </div>
      ...
      <div class='i026jp i026jp-m mj642v'>
        ...
        <div class='i026jp-desc invisible' id='p327i39d-table'>
          <div class='hfkanh'>
            ...
            <div class='lnq8e3' id='p327i39d-close'>
              <img src='img/close-cross-no-space.svg'>
            </div>
      ...
      <div class='col-h-stretch'>
        ...
        <div class='i026jp-desc r3wkac invisible' id='rc3k4yvc-table'>
          <div class='hfkanh'>
            ...
            <div class='lnq8e3' id='rc3k4yvc-close'>
              <img src='img/close-cross-no-space.svg'>
            </div>
        ...
        <div class='i026jp-desc invisible' id='dwk5jud2-table'>
          <div class='hfkanh'>
            ...
            <div class='lnq8e3' id='dwk5jud2-close'>
              <img src='img/close-cross-no-space.svg'>
            </div>
        ...
        <div class='i026jp stretch-auto i026jp-m'>
          ...
          <div class='i026jp-legend he-25 ps-0'>
